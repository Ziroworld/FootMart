...
export default function LoginPageComponent() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      ...
      // Update context (triggers cart fetch)
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <div className="flex items-center gap-2 px-10 pt-4 pb-2">
        <img
          src={logo}
          alt="FootMart Logo"
      ...
      <div className="flex flex-col items-center flex-1 w-full py-10">
        ...
        <div className="w-full max-w-xl rounded-2xl border border-gray-200 bg-white px-24 py-14 mb-10 shadow-lg relative">
          ...
          <form onSubmit={handleSubmit}>
            <p className="mb-7 font-semibold text-[#006241] text-[15px]">* indicates required field</p>
            <div className="mb-7">
              <input
                type="text"
                ...
                className={`w-full h-12 rounded-md border px-4 placeholder-gray-400 text-[18px] font-semibold transition ${
            ...
            <div className="mb-5 relative">
              <input
                ...
                className={`w-full h-12 rounded-md border px-4 pr-12 text-[18px] font-semibold transition ${
            ...
            <div className="mb-7 flex flex-col gap-2">
              ...
              <a href="#" className="text-[#006241] font-bold text-[15px] hover:underline text-left">
        ...
        <div className="w-full max-w-xl flex flex-col items-center justify-center py-6 mb-10">
          ...
          <button className="border border-green-700 text-green-700 font-semibold rounded-full px-7 py-2 bg-white hover:bg-green-50 transition" onClick={() => navigate("/auth/register")}>Join now</button>
        </div>
      </div>
    </div>
  );
